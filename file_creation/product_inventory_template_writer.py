...
class ProjectInventoryTemplateWriter(object):
	...
	def get_contact_person_realized_in_data_collection_project(self):
		...
		select_clause, shape_clause, where_clause, extra_joins, optional_shape = IngestLib.data_template_helper(subject, schema, self.ingest_prefix, joins, primary_key)

		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'contact_person_realized_in_data_collection_project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_grant_is_specified_input_of_data_collection_project(self):
		...
		select_clause, shape_clause, where_clause, extra_joins, optional_shape = IngestLib.data_template_helper(subject, schema, self.ingest_prefix, joins, primary_key)
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'grant_is_specified_input_of_data_collection_project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_data_collection(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, True, optional_shape)
	...
	def get_highlighted_web_resource_is_about_data_collection_project(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'highlighted_web_resource_is_about_data_collection_project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_data_collection_is_specified_output_of_data_collection_project(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection_is_specified_output_of_data_collection_project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_license(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'license.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, True, optional_shape)
	...
	def get_data_collection_modality_classification(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection_modality_classification.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_license_is_about_data_collection_project(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'license_is_about_data_collection_project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_data_collection_project_is_part_of_sub_program(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection_project_is_part_of_sub_program.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_modality(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'modality.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_data_collection_project_is_related_to_data_collection_project(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection_project_is_related_to_data_collection_project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_organization(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'organization.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, True, optional_shape)
	...
	def get_data_collection_project_modality_classification(self): 
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection_project_modality_classification.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_person(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'person.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, True, optional_shape)
	...
	def get_data_collection_project_species_classification(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection_project_species_classification.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_project(self):
		...
		select_clause, shape_clause, where_clause, extra_joins, optional_shape = IngestLib.data_template_helper(subject, schema, self.ingest_prefix, joins, primary_key)
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, True, optional_shape)
	...
	def get_data_collection_project_specimen_type_classification(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection_project_specimen_type_classification.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_protocol(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'protocol.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, True, optional_shape)
	...
	def get_data_collection_project_technique_classification(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection_project_technique_classification.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_protocol_is_about_data_collection_project(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'protocol_is_about_data_collection_project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_data_collection_reported_specimen_count(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection_reported_specimen_count.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_publication(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'publication.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, True, optional_shape)
	...
	def get_data_collection_species_classification(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection_species_classification.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_publication_is_about_data_collection(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'publication_is_about_data_collection.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_data_collection_specimen_type_classification(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection_specimen_type_classification.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_publication_is_about_data_collection_project(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'publication_is_about_data_collection_project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_data_collection_technique_classification(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_collection_technique_classification.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_species(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'species.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_data_contributor_realized_in_data_collection_project(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_contributor_realized_in_data_collection_project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_specimen_type(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'specimen_type.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_data_creator_realized_in_data_collection_project(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_creator_realized_in_data_collection_project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_sub_program_is_part_of_program(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'sub_program_is_part_of_program.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_data_publication_year_is_about_data_collection_project(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_publication_year_is_about_data_collection_project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_technique(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'technique.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_data_publisher_realized_in_data_collection_project(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'data_publisher_realized_in_data_collection_project.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_web_resource(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'web_resource.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, True, optional_shape)
	...
	def get_web_resource_is_about_data_collection(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'web_resource_is_about_data_collection.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, False, optional_shape)
	...
	def get_grant(self):
		...
		return IngestLib.create_data_template_validation(subject, True, 'csv', self.ingest_prefix, 'grant.csv', select_clause, shape_clause, where_clause, schema, joins, extra_joins, primary_key, True, optional_shape)